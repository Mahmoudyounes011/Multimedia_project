...
namespace WindowsFormsApp3 {
    ...
    public partial class DB1DataSet : global::System.Data.DataSet {
        ...
        public partial class ImagesDataTable : global::System.Data.TypedTableBase<ImagesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ImagesRow AddImagesRow(string Name, string path, string type, System.DateTime Date) {
        ...
        public partial class ImagesRow : global::System.Data.DataRow {
            ...
            public string type {
                get {
                    return ((string)(this[this.tableImages.typeColumn]));
                }
                set {
                    this[this.tableImages.typeColumn] = value;
                }
            }
            ...
            public System.DateTime Date {
                get {
                    return ((global::System.DateTime)(this[this.tableImages.DateColumn]));
                }
                set {
                    this[this.tableImages.DateColumn] = value;
                }
            }
        }
    ...
    public partial class ImagesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Images] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_N" +
                "ame) AND ([type] = @Original_type) AND ([Date] = @Original_Date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Images] ([Name], [path], [type], [Date]) VALUES (@Name, @path," +
                " @type, @Date);\r\nSELECT Id, Name, path, type, Date FROM Images WHERE (Id = SCOPE" +
                "_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Images] SET [Name] = @Name, [path] = @path, [type] = @type, [Date] = @Date WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([type] = @Original_type) AND ([Date] = @Original_Date));
SELECT Id, Name, path, type, Date FROM Images WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, path, type, Date FROM dbo.Images";
        ...
        public virtual int Fill(DB1DataSet.ImagesDataTable dataTable) {
        ...
        public virtual DB1DataSet.ImagesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DB1DataSet.ImagesDataTable dataTable = new DB1DataSet.ImagesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DB1DataSet.ImagesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_type, System.DateTime Original_Date) {
        ...
        public virtual int Insert(string Name, string path, string type, System.DateTime Date) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string path, string type, System.DateTime Date, int Original_Id, string Original_Name, string Original_type, System.DateTime Original_Date, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string path, string type, System.DateTime Date, int Original_Id, string Original_Name, string Original_type, System.DateTime Original_Date) {
            return this.Update(Name, path, type, Date, Original_Id, Original_Name, Original_type, Original_Date, Original_Id);
        }
    }
